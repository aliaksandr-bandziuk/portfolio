            ...
            <div className={styles.contactInfo}>
              ...
              <div className={styles.divider}>
                <svg xmlns="http://www.w3.org/2000/svg" width="117" height="2" viewBox="0 0 117 2" fill="none">
                  ...
                  <defs>
                    <linearGradient id="paint0_linear_16_101" x1="-1.10394" y1="1.00004" x2="-1.09485" y2="-0.0666686" gradientUnits="userSpaceOnUse">
              ...
              <h3 className={styles.contactSubtitle}>Let&apos;s create a cool project for you</h3>
            </div>
            <Contact />
          </div>
        </div>
